...
const SectionCard = ({ section }: SectionCardProps )=>{
  return (
    <Link className="p-4 shadow shadow-dark-accent/20 bg-secondary dark:bg-secondary/50 dark:text-secondary min-w-[15rem] flex-1 text-dark-accent rounded-md" href={`/user/sections/${section.section.id}`}>
